...
namespace Project_Thoth.Areas.AdminPanel.Models
{
    /// <summary>
    /// The model that represents an API displayed on the admin page.
    /// </summary>
    public class AdminApiModel
    {
        /// <summary>
        /// Initialize a new instance of the <see cref="AdminApiModel"/> class.
        /// <summary>

        ...
        var routeResolver = function () {
            ...
            this.routeConfig = function () {
                ...
                setBaseDirectories = function (viewsDir, controllersDir) {
                    ...
                    controllesrDirectory = controllersDir;
                },
            ...
            this.route = function (routeConfig) {
                var resolve = function (baseName, path, controllerAs, secure) {
                    ...
                    routeDef.templateUrl = routeConfig.getViewsDirectory() + path + baseFileName + '.cshtml';
                ...
                resolverDependencies = function ($q, $rootScope, dependencied) {
                    var defer = $q.defer();
